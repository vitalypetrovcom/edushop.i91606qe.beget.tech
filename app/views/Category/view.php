                    ...
                    <div class="col-sm-6">
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="input-sort">
                                ...
                                <option value="sort=title_asc" <?php if (isset($_GET['sort']) && $_GET['sort'] == 'title_asc') echo 'selected' ?> ><?php __ ('category_view_sort_title_asc'); ?></option> <!-- Фиксация выбранной сортировки пользователем на всех страницах пагинации  -->
            ...
            <div class="row">
                <?php if (!empty($products)): ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                                <?= count($products) ?> <?php __('tpl_total_pagination'); ?> <?= $total ?>
                            </p> <!-- Например, 3 товара(ов) из 10 -->
