                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu">
                            <?php if (empty($_SESSION['user'])): ?> <!-- Проверка, если у нас нет такого зарегистрированного пользователя -->
                                <li><a class="dropdown-item" href="user/login"><?php __ ('tpl_login');?></a></li> <!-- Выводим "Авторизация" -->
                                <li><a class="dropdown-item" href="user/signup"><?php __ ('tpl_signup');?></a></li> <!-- Выводим "Регистрация" -->
                                <?php else: ?>
                                <li><a class="dropdown-item" href="user/cabinet"><?php __ ('tpl_cabinet');?></a></li> <!-- Выводим "Кабинет" -->
                                <li><a class="dropdown-item" href="user/logout"><?php __ ('tpl_logout');?></a></li> <!-- Выводим "Выход" -->
                            <?php endif; ?>
                        </ul>
                    </div>

                    <?php new \app\widgets\language\Language() ?> <!--Вывод виджета языков-->
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <?php new \app\widgets\menu\Menu([ /* Подключаем виджет главного меню категорий */
