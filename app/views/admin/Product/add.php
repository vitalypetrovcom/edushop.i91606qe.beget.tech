...
<script>
    function popupBaseImage() { /* Функция для загрузки одной картинки */
        CKFinder.popup( {
            chooseFiles: true,
...
<script>
    function popupGalleryImage() { /* Функция для загрузки множества картинок */
        CKFinder.popup( {
            chooseFiles: true,
            onInit: function( finder ) {
                finder.on( 'files:choose', function( evt ) {
...
<script> /* Прикрепление редактора CKEditor на страницу */
    window.editors = {};
