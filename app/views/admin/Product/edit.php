            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (isset($product[$key]['download_id'])): ?> <!-- Если у нас товар цифровой -->
                            <p class="clear-download">
                                <span class="btn btn-danger">Обычный товар</span>  <!-- Добавляем кнопку "Обычный товар" чтобы можно было убрать прикрепленный файл и сделать товар обычным -->
                            </p>
                        <?php endif; ?> <!-- Делаем и выводим выпадающий список прикрепляемых файлов  -->
                        ...
                        <div class="card-body">
                            ...
                            <div id="base-img-output" class="upload-images base-image">
                                <div class="product-img-upload">
                                    <img src="<?= $product[$key]['img'] ?>"> <!-- Основное фото выводим в нужной нам разметке -->
                                    <input type="hidden" name="img" value="<?= $product[$key]['img'] ?>">
                                    <?php if ($product[$key]['img'] != NO_IMAGE): ?> <!-- Если у нас путь к картинке не равен константе NO_IMAGE (есть прикрепленное изображение) -->
                                        <button class="del-img btn btn-app bg-danger"><i class="far fa-trash-alt"></i>
                                        </button> <!-- Добавляем кнопку "удалить картинку" -->
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            ...
                            <div id="gallery-img-output" class="upload-images gallery-image">
                                <?php if (!empty($gallery)): ?> <!-- Если у нас не пусто в gallery (есть дополнительные фото) -->
                                    <?php foreach ($gallery as $item): ?>
                                        <div class="product-img-upload">
                                            <img src="<?= $item ?>"> <!-- Выводим в цикле картинки с нужной разметкой -->
