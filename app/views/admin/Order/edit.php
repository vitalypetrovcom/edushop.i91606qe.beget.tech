...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table text-start table-bordered"> <!-- Наименование колонок таблицы о товарах в заказе -->
                <thead>
                <tr>
                ...
                <tbody>
                <?php foreach ($order as $item): ?> <!-- Заполняем таблицу в цикле данными заказа из БД -->
                    <tr>
        ...
        <div class="box"> <!-- Наименование таблицы о деталях заказа -->
        ...
        <?php if (!$order[0]['status']): ?> <!-- Ссылки на изменение статуса заказа -->
