...
/*            $this->data = R::getAssoc("SELECT c.*, cd.* FROM category c
            ...
            $this->data = App::$app->getProperty ("categories_{$this->language['code']}"); // Получаем из нашего контейнера по ключу categories_{$this->language['code']} массив с данными всех категорий (АЛЬТЕРНАТИВНЫЙ ВАРИАНТ для выше закомментированного кода)
