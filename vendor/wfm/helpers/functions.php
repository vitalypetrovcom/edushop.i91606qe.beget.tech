...
function get_field_value ($name) { // Функция для обработки вводимых данных пользователем в форму. Принимает на вход название поля $name, значение которого нужно вернуть
