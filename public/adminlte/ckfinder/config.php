...
$config['authentication'] = function () { /* Управление доступом для пользователей визуального редактора */
    session_start();
    return (isset($_SESSION['user']) && $_SESSION['user']['role'] == 'admin'); // Разрешаем доступ использования визуального редактора только для админа (выполнение функции даст true)
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = ''; // В бесплатной версии мы можем загружать картинки, но удалять их не можем (платная версия)
$config['licenseKey']  = '';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/public/uploads/', // В нашем случае, указываем '/public/uploads/'
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
/*function getLabel() { // Попытка установить язык редактора RU
    $lang = 'ru';
    $labels = array(
        'ru' => 'Files',
        'en' => 'Fichiers',
